...
public class eChartTest10Logic : BaseNetLogic
{
    ...
    private void RefreshRadarGraph()
    {
        ...
        string templatePath = projectPath + folderSeparator + "eCharts10" + folderSeparator + "Template-data.js";
        string filePath = projectPath + folderSeparator + "eCharts10" + folderSeparator + "data.js";
        ...
        */
        ...
        for (int i = 1; i < 145; i++)
        {
            ...
            string variableName = "Model/eCharts/eCharts10/Min" + i;
