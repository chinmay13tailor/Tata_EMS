...
public class eChartTest2Logic : BaseNetLogic
{
    ...
    private void RefreshRadarGraph()
    {
        ...
        string templatePath = projectPath + folderSeparator + "eCharts2" + folderSeparator + "Template-data.js";
        string filePath = projectPath + folderSeparator + "eCharts2" + folderSeparator + "data.js";
        ...
        for (int i = 1; i < 94; i++)
        {
            text = text.Replace(i < 10 ? "$0" + i : "$" + i, (Project.Current.GetVariable("Model/eCharts/eCharts2/Day" + i).Value * 1.0).ToString("0.0"));
        }
