...
public class eChartTest5Logic : BaseNetLogic
{
    ...
    private void RefreshRadarGraph()
    {
        ...
        string templatePath = projectPath + folderSeparator + "eCharts5" + folderSeparator + "Template-data.js";
        string filePath = projectPath + folderSeparator + "eCharts5" + folderSeparator + "data.js";
