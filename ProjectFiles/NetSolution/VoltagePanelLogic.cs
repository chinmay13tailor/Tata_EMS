    ...
    public void VoltagePanrelTagsCalculation()
    {
       ...
       // var myStore145 = project.GetObject("DataStores").Get<Store.Store>("ODBCDatabase145");
        ...
        if (button == true)
        {
            ...
            string query1 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 00:00:00' AND '" + currentDate + " 00:09:59' AND Meter = '" + meter1 + "' ";
                                                     
            
             string query2 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 00:10:00' AND '" + currentDate + " 00:19:59' AND Meter = '" + meter1 + "' ";
             string query3 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 00:20:00' AND '" + currentDate + " 00:29:59' AND Meter = '" + meter1 + "' ";
             string query4 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 00:30:00' AND '" + currentDate + " 00:39:59' AND Meter = '" + meter1 + "' ";
             string query5 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 00:40:00' AND '" + currentDate + " 00:49:59' AND Meter = '" + meter1 + "' ";
             string query6 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 00:50:00' AND '" + currentDate + " 00:59:59' AND Meter = '" + meter1 + "' ";
             string query7 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 01:00:00' AND '" + currentDate + " 01:09:59' AND Meter = '" + meter1 + "' ";
             string query8 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 01:10:00' AND '" + currentDate + " 01:19:59' AND Meter = '" + meter1 + "' ";
             string query9 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 01:20:00' AND '" + currentDate + " 01:29:59' AND Meter = '" + meter1 + "' ";
             string query10 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 01:30:00' AND '" + currentDate + " 01:39:59' AND Meter = '" + meter1 + "' ";
             string query11 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 01:40:00' AND '" + currentDate + " 01:49:59' AND Meter = '" + meter1 + "' ";
             string query12 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 01:50:00' AND '" + currentDate + " 01:59:59' AND Meter = '" + meter1 + "' ";
             string query13 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 02:00:00' AND '" + currentDate + " 02:09:59' AND Meter = '" + meter1 + "' ";
             string query14 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 02:10:00' AND '" + currentDate + " 02:19:59' AND Meter = '" + meter1 + "' ";
             string query15 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 02:20:00' AND '" + currentDate + " 02:29:59' AND Meter = '" + meter1 + "' ";
             string query16 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 02:30:00' AND '" + currentDate + " 02:39:59' AND Meter = '" + meter1 + "' ";
             string query17 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 02:40:00' AND '" + currentDate + " 02:49:59' AND Meter = '" + meter1 + "' ";
             string query18 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 02:50:00' AND '" + currentDate + " 02:59:59' AND Meter = '" + meter1 + "' ";
             string query19 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 03:00:00' AND '" + currentDate + " 03:09:59' AND Meter = '" + meter1 + "' ";
             string query20 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 03:10:00' AND '" + currentDate + " 03:19:59' AND Meter = '" + meter1 + "' ";
             string query21 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 03:20:00' AND '" + currentDate + " 03:29:59' AND Meter = '" + meter1 + "' ";
             string query22 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 03:30:00' AND '" + currentDate + " 03:39:59' AND Meter = '" + meter1 + "' ";
             string query23 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 03:40:00' AND '" + currentDate + " 03:49:59' AND Meter = '" + meter1 + "' ";
             string query24 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 03:50:00' AND '" + currentDate + " 03:59:59' AND Meter = '" + meter1 + "' ";
             string query25 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 04:00:00' AND '" + currentDate + " 04:09:59' AND Meter = '" + meter1 + "' ";
             string query26 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 04:10:00' AND '" + currentDate + " 04:19:59' AND Meter = '" + meter1 + "' ";
             string query27 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 04:20:00' AND '" + currentDate + " 04:29:59' AND Meter = '" + meter1 + "' ";
             string query28 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 04:30:00' AND '" + currentDate + " 04:39:59' AND Meter = '" + meter1 + "' ";
             string query29 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 04:40:00' AND '" + currentDate + " 04:49:59' AND Meter = '" + meter1 + "' ";
             string query30 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 04:50:00' AND '" + currentDate + " 04:59:59' AND Meter = '" + meter1 + "' ";
             string query31 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 05:00:00' AND '" + currentDate + " 05:09:59' AND Meter = '" + meter1 + "' ";
             string query32 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 05:10:00' AND '" + currentDate + " 05:19:59' AND Meter = '" + meter1 + "' ";
             string query33 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 05:20:00' AND '" + currentDate + " 05:29:59' AND Meter = '" + meter1 + "' ";
             string query34 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 05:30:00' AND '" + currentDate + " 05:39:59' AND Meter = '" + meter1 + "' ";
             string query35 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 05:40:00' AND '" + currentDate + " 05:49:59' AND Meter = '" + meter1 + "' ";
             string query36 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 05:50:00' AND '" + currentDate + " 05:59:59' AND Meter = '" + meter1 + "' ";
             string query37 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 06:00:00' AND '" + currentDate + " 06:09:59' AND Meter = '" + meter1 + "' ";
             string query38 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 06:10:00' AND '" + currentDate + " 06:19:59' AND Meter = '" + meter1 + "' ";
             string query39 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 06:20:00' AND '" + currentDate + " 06:29:59' AND Meter = '" + meter1 + "' ";
             string query40 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 06:30:00' AND '" + currentDate + " 06:39:59' AND Meter = '" + meter1 + "' ";
             string query41 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 06:40:00' AND '" + currentDate + " 06:49:59' AND Meter = '" + meter1 + "' ";
             string query42 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 06:50:00' AND '" + currentDate + " 06:59:59' AND Meter = '" + meter1 + "' ";
             string query43 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 07:00:00' AND '" + currentDate + " 07:09:59' AND Meter = '" + meter1 + "' ";
             string query44 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 07:10:00' AND '" + currentDate + " 07:19:59' AND Meter = '" + meter1 + "' ";
             string query45 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 07:20:00' AND '" + currentDate + " 07:29:59' AND Meter = '" + meter1 + "' ";
             string query46 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 07:30:00' AND '" + currentDate + " 07:39:59' AND Meter = '" + meter1 + "' ";
             string query47 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 07:40:00' AND '" + currentDate + " 07:49:59' AND Meter = '" + meter1 + "' ";
             string query48 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 07:50:00' AND '" + currentDate + " 07:59:59' AND Meter = '" + meter1 + "' ";
             string query49 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 08:00:00' AND '" + currentDate + " 08:09:59' AND Meter = '" + meter1 + "' ";
             string query50 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 08:10:00' AND '" + currentDate + " 08:19:59' AND Meter = '" + meter1 + "' ";
             string query51 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 08:20:00' AND '" + currentDate + " 08:29:59' AND Meter = '" + meter1 + "' ";
             string query52 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 08:30:00' AND '" + currentDate + " 08:39:59' AND Meter = '" + meter1 + "' ";
             string query53 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 08:40:00' AND '" + currentDate + " 08:49:59' AND Meter = '" + meter1 + "' ";
             string query54 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 08:50:00' AND '" + currentDate + " 08:59:59' AND Meter = '" + meter1 + "' ";
             string query55 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 09:00:00' AND '" + currentDate + " 09:09:59' AND Meter = '" + meter1 + "' ";
             string query56 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 09:10:00' AND '" + currentDate + " 09:19:59' AND Meter = '" + meter1 + "' ";
             string query57 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 09:20:00' AND '" + currentDate + " 09:29:59' AND Meter = '" + meter1 + "' ";
             string query58 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 09:30:00' AND '" + currentDate + " 09:39:59' AND Meter = '" + meter1 + "' ";
             string query59 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 09:40:00' AND '" + currentDate + " 09:49:59' AND Meter = '" + meter1 + "' ";
             string query60 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 09:50:00' AND '" + currentDate + " 09:59:59' AND Meter = '" + meter1 + "' ";
             string query61 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 10:00:00' AND '" + currentDate + " 10:09:59' AND Meter = '" + meter1 + "' ";
             string query62 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 10:10:00' AND '" + currentDate + " 10:19:59' AND Meter = '" + meter1 + "' ";
             string query63 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 10:20:00' AND '" + currentDate + " 10:29:59' AND Meter = '" + meter1 + "' ";
             string query64 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 10:30:00' AND '" + currentDate + " 10:39:59' AND Meter = '" + meter1 + "' ";
             string query65 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 10:40:00' AND '" + currentDate + " 10:49:59' AND Meter = '" + meter1 + "' ";
             string query66 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 10:50:00' AND '" + currentDate + " 10:59:59' AND Meter = '" + meter1 + "' ";
             string query67 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 11:00:00' AND '" + currentDate + " 11:09:59' AND Meter = '" + meter1 + "' ";
             string query68 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 11:10:00' AND '" + currentDate + " 11:19:59' AND Meter = '" + meter1 + "' ";
             string query69 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 11:20:00' AND '" + currentDate + " 11:29:59' AND Meter = '" + meter1 + "' ";
             string query70 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 11:30:00' AND '" + currentDate + " 11:39:59' AND Meter = '" + meter1 + "' ";
             string query71 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 11:40:00' AND '" + currentDate + " 11:49:59' AND Meter = '" + meter1 + "' ";
             string query72 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 11:50:00' AND '" + currentDate + " 11:59:59' AND Meter = '" + meter1 + "' ";
             string query73 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 12:00:00' AND '" + currentDate + " 12:09:59' AND Meter = '" + meter1 + "' ";
             string query74 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 12:10:00' AND '" + currentDate + " 12:19:59' AND Meter = '" + meter1 + "' ";
             string query75 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 12:20:00' AND '" + currentDate + " 12:29:59' AND Meter = '" + meter1 + "' ";
             string query76 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 12:30:00' AND '" + currentDate + " 12:39:59' AND Meter = '" + meter1 + "' ";
             string query77 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 12:40:00' AND '" + currentDate + " 12:49:59' AND Meter = '" + meter1 + "' ";
             string query78 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 12:50:00' AND '" + currentDate + " 12:59:59' AND Meter = '" + meter1 + "' ";
             string query79 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 13:00:00' AND '" + currentDate + " 13:09:59' AND Meter = '" + meter1 + "' ";
             string query80 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 13:10:00' AND '" + currentDate + " 13:19:59' AND Meter = '" + meter1 + "' ";
             string query81 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 13:20:00' AND '" + currentDate + " 13:29:59' AND Meter = '" + meter1 + "' ";
             string query82 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 13:30:00' AND '" + currentDate + " 13:39:59' AND Meter = '" + meter1 + "' ";
             string query83 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 13:40:00' AND '" + currentDate + " 13:49:59' AND Meter = '" + meter1 + "' ";
             string query84 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 13:50:00' AND '" + currentDate + " 13:59:59' AND Meter = '" + meter1 + "' ";
             string query85 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 14:00:00' AND '" + currentDate + " 14:09:59' AND Meter = '" + meter1 + "' ";
             string query86 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 14:10:00' AND '" + currentDate + " 14:19:59' AND Meter = '" + meter1 + "' ";
             string query87 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 14:20:00' AND '" + currentDate + " 14:29:59' AND Meter = '" + meter1 + "' ";
             string query88 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 14:30:00' AND '" + currentDate + " 14:39:59' AND Meter = '" + meter1 + "' ";
             string query89 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 14:40:00' AND '" + currentDate + " 14:49:59' AND Meter = '" + meter1 + "' ";
             string query90 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 14:50:00' AND '" + currentDate + " 14:59:59' AND Meter = '" + meter1 + "' ";
             string query91 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 15:00:00' AND '" + currentDate + " 15:09:59' AND Meter = '" + meter1 + "' ";
             string query92 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 15:10:00' AND '" + currentDate + " 15:19:59' AND Meter = '" + meter1 + "' ";
             string query93 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 15:20:00' AND '" + currentDate + " 15:29:59' AND Meter = '" + meter1 + "' ";
             string query94 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 15:30:00' AND '" + currentDate + " 15:39:59' AND Meter = '" + meter1 + "' ";
             string query95 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 15:40:00' AND '" + currentDate + " 15:49:59' AND Meter = '" + meter1 + "' ";
             string query96 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 15:50:00' AND '" + currentDate + " 15:59:59' AND Meter = '" + meter1 + "' ";
             string query97 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 16:00:00' AND '" + currentDate + " 16:09:59' AND Meter = '" + meter1 + "' ";
             string query98 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 16:10:00' AND '" + currentDate + " 16:19:59' AND Meter = '" + meter1 + "' ";
             string query99 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 16:20:00' AND '" + currentDate + " 16:29:59' AND Meter = '" + meter1 + "' ";
             string query100 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 16:30:00' AND '" + currentDate + " 16:39:59' AND Meter = '" + meter1 + "' ";
             string query101 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 16:40:00' AND '" + currentDate + " 16:49:59' AND Meter = '" + meter1 + "' ";
             string query102 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 16:50:00' AND '" + currentDate + " 16:59:59' AND Meter = '" + meter1 + "' ";
             string query103 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 17:00:00' AND '" + currentDate + " 17:09:59' AND Meter = '" + meter1 + "' ";
             string query104 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 17:10:00' AND '" + currentDate + " 17:19:59' AND Meter = '" + meter1 + "' ";
             string query105 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 17:20:00' AND '" + currentDate + " 17:29:59' AND Meter = '" + meter1 + "' ";
             string query106 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 17:30:00' AND '" + currentDate + " 17:39:59' AND Meter = '" + meter1 + "' ";
             string query107 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 17:40:00' AND '" + currentDate + " 17:49:59' AND Meter = '" + meter1 + "' ";
             string query108 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 17:50:00' AND '" + currentDate + " 17:59:59' AND Meter = '" + meter1 + "' ";
             string query109 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 18:00:00' AND '" + currentDate + " 18:09:59' AND Meter = '" + meter1 + "' ";
             string query110 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 18:10:00' AND '" + currentDate + " 18:19:59' AND Meter = '" + meter1 + "' ";
             string query111 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 18:20:00' AND '" + currentDate + " 18:29:59' AND Meter = '" + meter1 + "' ";
             string query112 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 18:30:00' AND '" + currentDate + " 18:39:59' AND Meter = '" + meter1 + "' ";
             string query113 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 18:40:00' AND '" + currentDate + " 18:49:59' AND Meter = '" + meter1 + "' ";
             string query114 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 18:50:00' AND '" + currentDate + " 18:59:59' AND Meter = '" + meter1 + "' ";
             string query115 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 19:00:00' AND '" + currentDate + " 19:09:59' AND Meter = '" + meter1 + "' ";
             string query116 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 19:10:00' AND '" + currentDate + " 19:19:59' AND Meter = '" + meter1 + "' ";
             string query117 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 19:20:00' AND '" + currentDate + " 19:29:59' AND Meter = '" + meter1 + "' ";
             string query118 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 19:30:00' AND '" + currentDate + " 19:39:59' AND Meter = '" + meter1 + "' ";
             string query119 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 19:40:00' AND '" + currentDate + " 19:49:59' AND Meter = '" + meter1 + "' ";
             string query120 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 19:50:00' AND '" + currentDate + " 19:59:59' AND Meter = '" + meter1 + "' ";
             string query121 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 20:00:00' AND '" + currentDate + " 20:09:59' AND Meter = '" + meter1 + "' ";
             string query122 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 20:10:00' AND '" + currentDate + " 20:19:59' AND Meter = '" + meter1 + "' ";
             string query123 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 20:20:00' AND '" + currentDate + " 20:29:59' AND Meter = '" + meter1 + "' ";
             string query124 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 20:30:00' AND '" + currentDate + " 20:39:59' AND Meter = '" + meter1 + "' ";
             string query125 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 20:40:00' AND '" + currentDate + " 20:49:59' AND Meter = '" + meter1 + "' ";
             string query126 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 20:50:00' AND '" + currentDate + " 20:59:59' AND Meter = '" + meter1 + "' ";
             string query127 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 21:00:00' AND '" + currentDate + " 21:09:59' AND Meter = '" + meter1 + "' ";
             string query128 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 21:10:00' AND '" + currentDate + " 21:19:59' AND Meter = '" + meter1 + "' ";
             string query129 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 21:20:00' AND '" + currentDate + " 21:29:59' AND Meter = '" + meter1 + "' ";
             string query130 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 21:30:00' AND '" + currentDate + " 21:39:59' AND Meter = '" + meter1 + "' ";
             string query131 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 21:40:00' AND '" + currentDate + " 21:49:59' AND Meter = '" + meter1 + "' ";
             string query132 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 21:50:00' AND '" + currentDate + " 21:59:59' AND Meter = '" + meter1 + "' ";
             string query133 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 22:00:00' AND '" + currentDate + " 22:09:59' AND Meter = '" + meter1 + "' ";
             string query134 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 22:10:00' AND '" + currentDate + " 22:19:59' AND Meter = '" + meter1 + "' ";
             string query135 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 22:20:00' AND '" + currentDate + " 22:29:59' AND Meter = '" + meter1 + "' ";
             string query136 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 22:30:00' AND '" + currentDate + " 22:39:59' AND Meter = '" + meter1 + "' ";
             string query137 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 22:40:00' AND '" + currentDate + " 22:49:59' AND Meter = '" + meter1 + "' ";
             string query138 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 22:50:00' AND '" + currentDate + " 22:59:59' AND Meter = '" + meter1 + "' ";
             string query139 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 23:00:00' AND '" + currentDate + " 23:09:59' AND Meter = '" + meter1 + "' ";
             string query140 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 23:10:00' AND '" + currentDate + " 23:19:59' AND Meter = '" + meter1 + "' ";
             string query141 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 23:20:00' AND '" + currentDate + " 23:29:59' AND Meter = '" + meter1 + "' ";
             string query142 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 23:30:00' AND '" + currentDate + " 23:39:59' AND Meter = '" + meter1 + "' ";
             string query143 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 23:40:00' AND '" + currentDate + " 23:49:59' AND Meter = '" + meter1 + "' ";
             string query144 = $"SELECT AVG(Voltage_RN) FROM HomePage WHERE LocalTimestamp BETWEEN '" + currentDate + " 23:50:00' AND '" + currentDate + " 23:59:59' AND Meter = '" + meter1 + "' ";
