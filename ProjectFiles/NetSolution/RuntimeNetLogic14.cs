...
public class RuntimeNetLogic14 : BaseNetLogic
{
    ...
    public override void Start()
    {
        ...
        var owner = (YphaseCurrent)LogicObject.Owner;
    ...
    public void HomePageCalculationTask()
    {
        ...
        if (button)
        {
            ...
            string query1 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '1' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query2 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '2' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query3 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '3' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query4 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '4' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query5 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '5' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query6 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '6' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query7 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '7' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query8 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '8' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query9 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '9' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query10 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '10' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query11 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '11' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query12 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '12' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query13 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '13' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query14 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '14' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query15 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '15' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query16 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '16' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query17 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '17' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query18 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '18' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query19 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '19' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query20 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '20' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query21 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '21' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query22 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '22' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query23 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '23' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query24 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '24' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query25 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '25' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query26 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '26' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query27 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '27' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query28 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '28' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query29 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '29' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query30 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '30' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
            string query31 = $"SELECT Phase_Y_Current FROM DailyJaceDataLogger WHERE Day = '31' AND MonthYear = '" + new12 + "' AND Jace = '" + jace1 + "' ";
