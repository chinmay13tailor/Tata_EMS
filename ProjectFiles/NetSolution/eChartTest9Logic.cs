...
public class eChartTest9Logic : BaseNetLogic
{
    ...
    private void RefreshRadarGraph()
    {
        ...
        string templatePath = projectPath + folderSeparator + "eCharts9" + folderSeparator + "Template-data.js";
        string filePath = projectPath + folderSeparator + "eCharts9" + folderSeparator + "data.js";
        ...
        */
        ...
        for (int i = 1; i < 145; i++)
        {
            ...
            string variableName = "Model/eCharts/eCharts9/Min" + i;
