...
option = { // Define the chart configuration options
    ...
    legend: {
        data: ['Phase_R_Current', 'Phase_Y_Current', 'Phase_B_Current'] // Specify legend data
    },
    ...
    series: [ // Configure chart series data
        {
            name: 'Phase_R_Current', // Series name
            type: 'line',
        ...
        {
            name: 'Phase_Y_Current', // Series name
            type: 'line',
            label: { // Configure labels for bars
                show: true // Show labels
            },
        ...
        {
            name: 'Phase_B_Current', // Series name
            type: 'line',
            label: { // Configure labels for bars
                show: true // Show labels
            },
