...
public class eChartTest7Logic : BaseNetLogic
{
    ...
    private void RefreshRadarGraph()
    {
        ...
        string templatePath = projectPath + folderSeparator + "eCharts7" + folderSeparator + "Template-data.js";
        string filePath = projectPath + folderSeparator + "eCharts7" + folderSeparator + "data.js";
        ...
        for (int i = 3; i < 4; i++)
        {
            text = text.Replace(i < 10 ? "$0" + i : "$" + i, (Project.Current.GetVariable("Model/eCharts/eCharts5/Day" + i).Value).ToString());
        }
